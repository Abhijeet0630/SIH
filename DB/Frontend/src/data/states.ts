...
export const STATES_DATA: Record<string, StateOverview> = {
  ...
  telangana: {
    ...
    region: 'South',
    isFullyDeveloped: false,
    culturalIdentity: 'Land of Kakatiya Heritage, Golconda Fortress, Ramappa Temple, and Bathukamma',
    shortDescription: 'Celebrated for the UNESCO-inscribed Ramappa Kakatiya temple, historic Golconda fortress, Bidri metal craft, Pochampally Ikat textiles, and the floral Bathukamma festival.',
  ...
  'andhra-pradesh': {
    ...
    region: 'South',
    isFullyDeveloped: false,
    culturalIdentity: 'Cradle of Classical Kuchipudi Dance, Kalamkari Block Art, and Ancient Buddhist Stupas',
    shortDescription: 'Renowned for classical Kuchipudi dance drama, sacred Tirumala Venkateswara shrine, Amaravati Buddhist heritage, and Machilipatnam Kalamkari textiles.',
  ...
  lakshadweep: {
    ...
    region: 'South',
    isFullyDeveloped: false,
    culturalIdentity: 'Coral Archipelago of 36 Atolls, Maritime Lore, Coir Craft, and Kolkali Folk Dance',
    shortDescription: 'India’s tropical coral archipelago in the Arabian Sea, celebrated for turquoise lagoons, traditional tuna pole-and-line fisheries, coir craftsmanship, and vibrant Kolkali and Parichakali folk dance traditions.',
  ...
  'andaman-and-nicobar': {
    ...
    region: 'South',
    isFullyDeveloped: false,
    culturalIdentity: 'Historic Cellular Jail, Ancient Indigenous Tribes, Tropical Rainforests, and Marine Heritage',
    shortDescription: 'Emerald island chain in the Bay of Bengal, home to the historic Cellular Jail monument of the freedom movement, ancient indigenous tribal cultures, and pristine marine biosphere reserves.',
...
export const getStateById = (stateId: string): StateOverview | undefined => {
  return STATES_DATA[stateId.toLowerCase()];
};

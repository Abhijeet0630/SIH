        ...
        <div className="site-container space-y-3.5">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            >
              ...
              <span>{t('stateAtlases.backToNationalMap') || 'Back to National Map'}</span>
            </Link>

            {/* State Quick Switcher Pills */}
            <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar py-0.5">
              <span className="text-xs font-medium text-parchment-500 hidden sm:inline shrink-0">
                {t('stateAtlases.featuredStates') || 'Featured States:'}
              </span>
              {[
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-parchment-200 pb-2">
            <div>
              <h3 className="font-serif text-base sm:text-lg font-bold text-parchment-950">
                {t('stateAtlases.verifiedLocations', { count: items.length }) || `Verified Heritage Locations (${items.length})`}
              </h3>
              <p className="text-xs text-parchment-500">
                {t('stateAtlases.clickCardToFocus') || 'Click any catalogue card to focus its landmark on the spatial atlas.'}
              </p>
            </div>
                ...
                >
                  ...
                  <div className="p-3.5 pt-0">
                    <div className="pt-2 border-t border-parchment-100 flex items-center justify-between text-[11px] font-semibold text-category-temples">
                      ...
                      >
                        <span>{t('stateAtlases.deepStory') || 'Deep Story'}</span>
                      ...
                      {item.model3DId ? (
                        <Link
                          ...
                          onClick={e => e.stopPropagation()}
                          className="px-2 py-0.5 rounded-full bg-amber-500 hover:bg-amber-600 text-stone-950 font-bold text-[10px] flex items-center gap-1 shadow-xs transition-transform hover:scale-105"
                        >
                        ...
                        <span className="text-[10px] text-parchment-400 font-normal">
                          {t('stateAtlases.asiVerified') || 'ASI Verified'}
                        </span>
                      )}
                    </div>
                  </div>
